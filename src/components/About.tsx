    ...
    <div className='about-page-wrap'>
      <div className='profile-wrap'>
        ...
        <div className='introduction-wrap'>
          元エンジニアのフリーランスUIデザイナーです。<br/>ワクワクすることを繰り返していたら、SIer→Webエンジニア→UIデザイナーというキャリアを歩んでいました。<br/>現在は複数のベンチャーでUIデザインをしています。<br/><br/>【得意】<br/>
          ・デザインの言語化<br/>
        ...
        ［2021~現在］フリーランスUI/UXデザイナーとして活動開始。
        </div>
